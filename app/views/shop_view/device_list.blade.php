<div class="handset-list">

	<div class="col-lg-12">
		<h3 class="section-title">DEVICE</h3>
		<p class="subheading">Choose a device from us or from one of our authorized partners</p>
	</div>

	@foreach ($products as $prod)
	@if($prod['sku'] != 'BYOD')
	<div class="col-xs-12 col-sm-6 col-lg-4 hanset-item">
